...
class EddyGatherSamples:
    ...
    def _pull_position(self, start_time, end_time, nom_pos):
        ...
        bed_deviation = nom_pos[2] - halt_z
        nom_pos[2] = self._z_offset + bed_deviation
        return nom_pos
    def pull_probed(self):
        results = []
        for start_time, end_time, nom_pos in self._probe_times:
            pos = self._pull_position(start_time, end_time, nom_pos)
            results.append(pos)
...
class EddyEndstopWrapper:
    ...
    def probing_move(self, pos, speed):
        ...
        self._gather.note_probe(start_time, end_time)
